...
{
    internal unsafe static class NativeMemoryUtility
    {
        public static byte* Allocate(long requiredByteCount, bool skipZeroClear)
        {
            ...
            if (IntPtr.Size == 4 && requiredByteCount > int.MaxValue)
                ThrowHelper.ThrowArgumentOutOfRangeException(nameof(requiredByteCount), requiredByteCount, Strings.ArgumentOutOfRange_ExceededMemoryLimitOn32Bit);
